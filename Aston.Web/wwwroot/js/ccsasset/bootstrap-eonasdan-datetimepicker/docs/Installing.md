...
<head>
  <!-- ... -->
  <script type="text/javascript" src="/js/ccsasset/jquery/jquery.min.js"></script>
  <script type="text/javascript" src="/js/ccsasset/moment/min/moment.min.js"></script>
  <script type="text/javascript" src="/js/ccsasset/bootstrap/dist/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="/js/ccsasset/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
  <link rel="stylesheet" href="/js/ccsasset/bootstrap/dist/css/bootstrap.min.css" />
  <link rel="stylesheet" href="/js/ccsasset/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css" />
</head>
```
## Nuget
